$(document).ready(function(){
    ...
    var typed = new Typed(".typing", {
        strings: ["Change the world by being yourself.", "Never regret anything that made you smile.", "Everything you can imagine is real.", "Whatever you do, do it well."],
        typeSpeed: 50,
        backSpeed: 50,
        loop: true
    });
    ...
    var typed = new Typed(".typing-2", {
        strings: ["Public Speaker", "Mentor", "Blogger", "Writter", "Youtuber"],
        typeSpeed: 100,
        backSpeed: 60,
        loop: true
    });
